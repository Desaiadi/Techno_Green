...
void DS1307_write(char sec, char min, char hr, char _day, char _date, char _month, char year);
...
unsigned char _sec , _min , _hr , _day , _date , _month , yr , _con ;
void main ( void )
{
TRISC = 0XFF ;
SSPCON = 0x28 ;
...
void DS1307_write ( char _second , char _minute , char _hour , char _day , char_date , char _month , char _year )
{
/ * Start bit * /
