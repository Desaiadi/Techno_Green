...
# 32 "RTC_with_PIC_main.c" 2

# 1 "./PIC16F877a_DS3231.h" 1
# 10 "./PIC16F877a_DS3231.h"
...
int main()
{
    ...
    Set_Time_Date();
     ...
     Lcd_Clear();
     Lcd_Set_Cursor(1,1);
     Lcd_Print_String("  TULIP FARM  ");
     Lcd_Set_Cursor(2,1);
     Lcd_Print_String("SMART IRRIGATION");
